...
var BaseChild = (function (_React$Component) {
	_inherits(BaseChild, _React$Component);

	function BaseChild() {
		_classCallCheck(this, BaseChild);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(BaseChild).apply(this, arguments));
	}

	return BaseChild;
})(_react2.default.Component);

BaseChild.contextTypes = {
	model: _react2.default.PropTypes.object.isRequired
};

exports.default = BaseChild;
},{"react":162,"react-dom":6}],3:[function(require,module,exports){
"use strict";
...
var BaseController = (function (_React$Component) {
	...
	function BaseController(props, context, obj) {
		_classCallCheck(this, BaseController);

		//Find the model
		//throw new Error(props.model==null);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BaseController).call(this, props, context));
...
},{"react":162,"react-dom":6}],4:[function(require,module,exports){
"use strict";
"user-strict";
...
var _baseChild = require('./base-child');

var _baseChild2 = _interopRequireDefault(_baseChild);
...
var Cauldron = {};
Cauldron.BaseController = _baseController2.default;
Cauldron.BaseChild = _baseChild2.default;
Cauldron.BaseModel = _baseModel2.default;

exports.default = Cauldron;
},{"./base-child":2,"./base-controller":3,"./base-model":4}],6:[function(require,module,exports){
'use strict';
...
var _demoModel = require('./demo-model');

var _demoModel2 = _interopRequireDefault(_demoModel);
...
var _cauldronMvc = require('cauldron-mvc');

var _cauldronMvc2 = _interopRequireDefault(_cauldronMvc);
...
var App = (function (_Cauldron$BaseControl) {
    _inherits(App, _Cauldron$BaseControl);

    function App(props, context) {
        _classCallCheck(this, App);

        var demo = new _demoModel2.default();
        return _possibleConstructorReturn(this, Object.getPrototypeOf(App).call(this, props, context, demo));
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'First Name:',
                        this.state.model.firstName ? this.state.model.firstName : "Please enter a first name"
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
                        'Last Name:',
                        this.state.model.lastName ? this.state.model.lastName : "Please enter a last name"
                    )
                ),
    ...
    return App;
})(_cauldronMvc2.default.BaseController);

exports.default = App;

},{"./demo-model":164,"./name":166,"./time":167,"cauldron-mvc":5,"react":162,"react-dom":6}],164:[function(require,module,exports){
'use strict';
...
var DemoModel = (function (_Cauldron$BaseModel) {
    _inherits(DemoModel, _Cauldron$BaseModel);

    function DemoModel() {
        _classCallCheck(this, DemoModel);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DemoModel).call(this));

        _this.setFirstName = function (e) {
            if (e.target) {
                _this.firstName = e.target.value;
            } else {
                _this.firstName = e;
            }
            _this.fireUpdateEvent();
        };

        _this.setLastName = function (e) {
            if (e.target) {
                _this.lastName = e.target.value;
            } else {
                _this.lastName = e;
            }
            _this.fireUpdateEvent();
        ...
        _this.firstName = "Mark";
        _this.lastName = "Clarke";
        _this.total = 0;
        _this.time = new Date();
    ...
    return DemoModel;
})(_cauldronMvc2.default.BaseModel);

exports.default = DemoModel;

},{"cauldron-mvc":5,"react":162,"react-dom":6}],165:[function(require,module,exports){
'use strict';
...
},{"./app":163,"react":162,"react-dom":6}],166:[function(require,module,exports){
'use strict';
...
var Name = (function (_Cualdron$BaseChild) {
    _inherits(Name, _Cualdron$BaseChild);
    ...
    _createClass(Name, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { name: 'lastName', id: 'lastName', type: 'text', size: '25',
                    value: this.context.model.firstName,
                    onChange: this.context.model.setFirstName }),
                _react2.default.createElement('br', null),
                _react2.default.createElement('input', { name: 'firstName', id: 'firstName',
    ...
    return Name;
})(_cauldronMvc2.default.BaseChild);

exports.default = Name;

},{"cauldron-mvc":5,"react":162,"react-dom":6}],167:[function(require,module,exports){
'use strict';
...
var Time = (function (_Cauldron$BaseChild) {
  _inherits(Time, _Cauldron$BaseChild);
  ...
  _createClass(Time, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        this.context.model.time.toString()
      );
    }
  }]);
...
},{"cauldron-mvc":5,"react":162,"react-dom":6}]},{},[165]);
